# Privacy Policy - LinkToChat (for Twitch)

**Last updated:** August 30, 2026

LinkToChat ("the extension") is a browser extension that lets you send the
...
To connect your Twitch account, LinkToChat uses Twitch's official OAuth
authorization flow. When you click "Connect," you are redirected to
Twitch's own login page, where you authorize LinkToChat to:
...
LinkToChat also reads the URL of your active browser tab, but only at the
...
LinkToChat has no backend server. There is no external server operated by
...
LinkToChat communicates directly with Twitch's API (id.twitch.tv,
...
You can disconnect LinkToChat from your Twitch account at any time,
